...
```
$ sudo ./apps/synthetic/target/release/synthetic 128.110.218.185:5000 --config client.config --mode runtime-client --start_mpps=0.5 --mpps=4.5 --samples=20 --rampup=10 --intersample_sleep=2
```
